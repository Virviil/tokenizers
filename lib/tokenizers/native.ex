defmodule Tokenizers.Native do
  ...
  def tokenizer_from_file(_path, _additional_special_tokens), do: err()
  def tokenizer_from_buffer(_buffer, _additional_special_tokens), do: err()
  def tokenizer_save(_tokenizer, _folder, _pretty), do: err()
  #
  ...
  def tokenizer_set_truncation(_tokenizer, _max_length, _opts), do: err()
  ...
  #
  def tokenizer_encode(_tokenizer, _input, _add_special_tokens), do: err()
  def tokenizer_encode_batch(_tokenizer, _inputs, _add_special_tokens), do: err()
  def tokenizer_decode(_tokenizer, _ids, _skip_special_tokens), do: err()
  def tokenizer_decode_batch(_tokenizer, _ids, _skip_special_tokens), do: err()
